...
class TestProblem(unittest.TestCase):
    ...
    def test_ampulhetas_de_5_e_4_da_8(self):
        self.assertEqual(8, miojo(5, 4))
    ...
    def test_ampulhetas_de_79_e_5_da_155(self):
        self.assertEqual(155, miojo(79, 5))

    def test_ampulhetas_de_5_e_79_da_155(self):
        self.assertEqual(155, miojo(5, 79))
